describe("Controller Test", function () {
    ...
    it("Limits interval to 10 updates", function () {
        for (var i = 0; i < 11; i++) {
            ...
            //методы которые предоставляют сервисы $timeout и $interval
            //$timeout flush(millis) устанавливает таймер на определенное колличество милисекунд
            //$timeout verifyNoPendingTasks() позволяет проверить есть ли callback которые еще не вызваны
            //$interval flush(millis) устанавливает таймер на определенное колличество милисекунд
        }
